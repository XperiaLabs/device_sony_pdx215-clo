...
# AVB (UBL/LBL)
BUILD_USE_CUSTOM_KEY := false
ifeq ($(BUILD_USE_CUSTOM_KEY),true)
BOARD_AVB_KEY_PATH := $(HOME)/custom_rsa4096_private.pem
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := $(HOME)/custom_rsa4096_private.pem
BOARD_AVB_RECOVERY_KEY_PATH := $(HOME)/custom_rsa4096_private.pem
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_pdx215_locked
TARGET_RECOVERY_DEVICE_MODULES := libinit_pdx215_locked
else
